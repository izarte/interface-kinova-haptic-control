...
classdef ArmPoseFeedback < ros.Message
    ...
    methods
        function set.Pose(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'ArmPoseFeedback', 'Pose')
            obj.Pose = val;
        end
    end
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.kinova_msgs.ArmPoseFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.kinova_msgs.ArmPoseFeedback(strObj);
        end
    end
end
