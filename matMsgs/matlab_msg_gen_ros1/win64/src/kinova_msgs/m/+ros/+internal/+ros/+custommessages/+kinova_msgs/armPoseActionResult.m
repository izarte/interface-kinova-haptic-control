function [data, info] = armPoseActionResult
%ArmPoseActionResult gives an empty data for kinova_msgs/ArmPoseActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'kinova_msgs/ArmPoseActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.kinova_msgs.armPoseResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'kinova_msgs/ArmPoseActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
