function [data, info] = armPoseResult
%ArmPoseResult gives an empty data for kinova_msgs/ArmPoseResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'kinova_msgs/ArmPoseResult';
[data.Pose, info.Pose] = ros.internal.ros.messages.geometry_msgs.poseStamped;
info.Pose.MLdataType = 'struct';
info.MessageType = 'kinova_msgs/ArmPoseResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
